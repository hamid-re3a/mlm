...
class UniLevelServiceProvider extends ServiceProvider
{
    private $routes_namespace = 'UniLevel\Http\Controllers';
    private $namespace = 'UniLevel';
    private $name = 'uni-level';
    private $config_file_name = 'uni_level';
...
//            $this->seed();
    ...
    {
        return UniLevelConfigure::$runsMigrations;
    }
    private function seed()
    {
        if (isset($_SERVER['argv']))
            if (array_search('db:seed', $_SERVER['argv'])) {
                UniLevelConfigure::seed();
            }
    }
